                ...
                <div key={index} className='max-w-4xl rounded-xl border-2 border-emerald-950 p-8'>
                    <div className='flex flex-col items-center justify-between md:flex-row md:items-start'>
                        <div className='mb-6 flex flex-col md:mb-0 md:w-1/2'>
                            ...
                            <div>
                                <button className='flex items-center gap-2 rounded-full bg-emerald-950 px-4 py-2 text-orange-50 hover:bg-emerald-900'><span>get Started</span><IoArrowForward /></button>
                            </div>
                            </div>
                    </div>
                </div>
